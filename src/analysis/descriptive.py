"""
Descriptive statistics — four outputs required by design §8.
=================================================================
...
# ---------------------------------------------------------------------------
# §4.1  Sample attrition table  (design §4.1)
# ---------------------------------------------------------------------------
...
def run_sample_attrition() -> None:
    ...
    Required by the pre-specified study design (§4.1, Universe and exclusions).
    """
    ...
    #       in build_features.py, as required by design §6.4);
...
def run_all_descriptive(
    ...
    """
    print("\n" + "="*60)
    print("  DESCRIPTIVE STATISTICS  (design §8)")
    print("="*60)
