...
Results are presented in a single consolidated table (Blueprint v4 §11).
...
def run_all_robustness(
    ...
    save_table(
        ...
        caption=(
            "Consolidated robustness results (Blueprint v4 §11). "
